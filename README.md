# Ad-Hoc Analysis in consumer goods industry for Supply Chain & Finance Teams of AtliQ Hardware: [Resume Project](https://codebasics.io/challenge/codebasics-resume-project-challenge)
...
## Creation of various automated reports using Stored Procedures: [_(Click Here)_](https://github.com/sujeet424/Ad-Hoc-Analysis-in-consumer-goods-industry-for-Supply-Chain-Finance/blob/master/Stored%20Procedures.sql)
...
## Creation of various views: [_(Click Here)_](https://github.com/sujeet424/Ad-Hoc-Analysis-in-consumer-goods-industry-for-Supply-Chain-Finance/blob/master/Views.sql)
...
## Creation of other reports using CTE & WINDOW FUNCTION: [_(Click Here)_](https://github.com/sujeet424/Ad-Hoc-Analysis-in-consumer-goods-industry-for-Supply-Chain-Finance/blob/master/cte%20%26%20window%20function.sql)
1. Net invoice sales amount
2. Top 3 products from each division by total quantity sold in a given year


## User Defined Fuctions: [_(Click Here)_](https://github.com/sujeet424/Ad-Hoc-Analysis-in-consumer-goods-industry-for-Supply-Chain-Finance/blob/master/User%20Defined%20Functions.sql)
1. FIscal Year
2. Quarters


## Performance Improvement: [_(Click Here)_](https://github.com/sujeet424/Ad-Hoc-Analysis-in-consumer-goods-industry-for-Supply-Chain-Finance/blob/master/Performance%20Improvement.sql)
